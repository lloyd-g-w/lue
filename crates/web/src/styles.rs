...
:root {
  ...
  --connection-ring: rgba(49, 95, 188, 0.1);
  --focus-ring: rgba(49, 95, 188, 0.12);
  --focus-ring-strong: rgba(49, 95, 188, 0.16);
  ...
  --role-admin-border: #a9bce4;
  --modal-backdrop: rgba(23, 25, 31, 0.32);
  --radius: 12px;
}
